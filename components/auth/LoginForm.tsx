    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary via-primary/90 to-primary/70 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-32 right-16 w-96 h-96 bg-white/5 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-1/2 left-1/3 w-48 h-48 bg-accent/20 rounded-full blur-2xl animate-pulse"
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              {["Manajemen Produk", "Kategori Dinamis", "Publikasi Instan"].map(
                (feature) => (
                  <div
                    key={feature}
